...
srand(uint s)
{
 ...
 586:	5d                   	pop    %ebp
  seed = s;
 587:	a3 80 0e 00 00       	mov    %eax,0xe80
}
 58c:	c3                   	ret    
...
random(void)
{
  seed = seed
    * 1103515245
 590:	69 05 80 0e 00 00 6d 	imul   $0x41c64e6d,0xe80,%eax
 597:	4e c6 41 
{
 59a:	55                   	push   %ebp
 ...
 59e:	05 39 30 00 00       	add    $0x3039,%eax
  seed = seed
 5a3:	a3 80 0e 00 00       	mov    %eax,0xe80
}
 5a8:	c3                   	ret    
 ...
 679:	85 d2                	test   %edx,%edx
{
 ...
 6e0:	e8 ec fe ff ff       	call   5d1 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 750:	e8 7c fe ff ff       	call   5d1 <write>
 ...
 7b1:	e8 1b fe ff ff       	call   5d1 <write>
 ...
 7c8:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 7ca:	e8 02 fe ff ff       	call   5d1 <write>
  for(i = 0; fmt[i]; i++){
 ...
 863:	57                   	push   %edi
 864:	53                   	push   %ebx
 865:	e8 67 fd ff ff       	call   5d1 <write>
        while(*s != 0){
 ...
 8b7:	e8 15 fd ff ff       	call   5d1 <write>
        ap++;
...
free(void *ap)
{
 ...
 8e1:	a1 a0 0e 00 00       	mov    0xea0,%eax
{
 ...
 91d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 91f:	a3 a0 0e 00 00       	mov    %eax,0xea0
}
 924:	5b                   	pop    %ebx
 925:	5e                   	pop    %esi
 926:	5f                   	pop    %edi
 ...
 936:	72 ce                	jb     906 <free+0x26>
{
 ...
 957:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 95a:	a3 a0 0e 00 00       	mov    %eax,0xea0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 979:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 97c:	8b 15 a0 0e 00 00    	mov    0xea0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9e6:	e8 f5 fe ff ff       	call   8e0 <free>
  return freep;
 9eb:	8b 15 a0 0e 00 00    	mov    0xea0,%edx
 ...
 a14:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 a17:	89 15 a0 0e 00 00    	mov    %edx,0xea0
}
 ...
 a29:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 a30:	c7 05 a0 0e 00 00 a4 	movl   $0xea4,0xea0
 a37:	0e 00 00 
 a3a:	c7 05 a4 0e 00 00 a4 	movl   $0xea4,0xea4
 a41:	0e 00 00 
    base.s.size = 0;
 a44:	b8 a4 0e 00 00       	mov    $0xea4,%eax
 a49:	c7 05 a8 0e 00 00 00 	movl   $0x0,0xea8
 a50:	00 00 00 
